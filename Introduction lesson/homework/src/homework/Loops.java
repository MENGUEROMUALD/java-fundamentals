...
public class Loops {
	...
	// lesson 5 Decisions and loops
		 ...
		 * System.out.println(counter); } // another option int counter = 0; for (;
		 * counter < 10;) // must have 2 semi-colons { System.out.println(counter++); }
		 * //counts down from 10 to 0 for(int y=10; y >=0; y--) { System.out.println(y);
		 * } int count = 10; for (;;) { if(count >=0){ System.out.println(count--);
		 * break; } } int score = 10; while(score !=0) { System.out.println(score--); }
		 * 
		 ...
		 * int x = 1, y;
		 * 
		 * System.out.println("Type in your number :"); y = input.nextInt();
		 * System.out.println(y+" x "+x+" = "+(y * x)); x=x+1; while(x !=13){
